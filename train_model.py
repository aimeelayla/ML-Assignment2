...
def preprocess_data(train_data_path, train_labels_path, save_components=True):
    ...
    base_features = X_processed.iloc[:, :top_n]
    ...
    interaction_only = interaction_features[:, top_n:]  # remove original features
    ...
    X_processed.columns = X_processed.columns.astype(str)  # Add this line
